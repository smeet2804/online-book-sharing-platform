<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="EditProfile.aspx.cs" Inherits="OBS.EditProfile" %>
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                     <div class="col">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="passTB" runat="server" placeholder="Password" TextMode="SingleLine"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                     <div class="form-group">
